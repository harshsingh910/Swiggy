  ...
  function handleDecrementItems(){
    ...
    return (
        ...
        <div className="flex w-full justify-between mb-2 pb-2">
          ...
          {
            (count==0)?(<button className="absolute bottom-1 left-17 rounded-xl text-lg text-green-600 px-5 py-1 shadow-md border border-white bg-white" onClick={()=>handleAdditems()}>ADD</button>):(
